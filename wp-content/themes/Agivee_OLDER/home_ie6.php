    ...
    <div class="content_wrap">
      <div id="content1">
        ...
        <div class="contentbox_1">
          ...
          <div class="contentbox_1box">
            <div class="aboutme_contentbox_2boxin" style="background:#dedede;height: 245px;margin:5px;#width:278px;"> <a id="quickguide" class="poplight" target="_blank" href="<?php echo get_template_directory_uri();?>/tutorial/index.html">Quick Guide</a> 
