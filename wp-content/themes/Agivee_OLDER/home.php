      ...
      <div id="content2">
        <div style="float:left;">
         <!-- start of Feature Focus -->
          ...
          <!-- start of Learnets -->
          <div style="width:675px;float:left;margin-top: 20px;">
            <div style="width:425px; height:19px;float:left;"> <img src="<?php bloginfo('template_directory');?>/images/redtab_learnets.jpg" alt="Learnets" border="0" /></div>
            <div class="ffocus_slidebox" style="width:660px; padding: 5px;height:290px;#height:315px;float:left; border: 1px solid #C8C8C8;background:#fff;text-align: center;"> 
              
              		<!-- start of Learnets Left -->
             <div style="width:324px; height:288px;#height:298px;float:left; border: 1px solid #C8C8C8;background:#fff;margin-bottom: 3px;">
                <div style="background-image:url(<?php bloginfo('template_directory');?>/images/learnets_lft_bg.jpg);background-repeat:repeat-x; background-color:#f4f4f4; height: 280px;width: 315px;margin: 4px auto;text-align: left;#height: 288px;">
                  
	                 <?php if (!function_exists('dynamic_sidebar') || !dynamic_sidebar('Learnets Left')) {
												                    } ?>
                </div>
                <div class="clear"></div>
              </div>
             <!-- end of Learnets Left -->
            <!-- start of Learnets Right -->
              <div style="width:324px; height:288px;#height:298px;float:right; border: 1px solid #C8C8C8;background:#fff;margin-bottom: 3px;">
                <div style="background: #f4f4f4;height: 278px;width: 315px;margin: 4px auto;text-align: left;#height: 288px;">
                  
	                 <?php if (!function_exists('dynamic_sidebar') || !dynamic_sidebar('Learnets Right')) {
												                    } ?>
                </div>
                <div class="clear"></div>
              </div>
              <!-- end of Learnets Right -->
