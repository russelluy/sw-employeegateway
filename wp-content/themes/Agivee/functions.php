...
if(!is_admin()){
	...
	//Dropdown Blk
	wp_enqueue_script('taba', get_template_directory_uri() . '/js/all.js', array('jquery'));
	//featured Sites Tabs???
	...
	//STAYS
	wp_enqueue_script('ajaxtooltip', get_template_directory_uri() . '/js/jquery.tools.min.js', array('jquery'));	
