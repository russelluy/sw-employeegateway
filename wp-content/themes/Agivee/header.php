                    ...
                    <div class="top-header_rt">
                    	<div class="top-header_rt_nav" style="font-family:Arial;">
                    		<ul id="nav"> 
							   ...
							   <li class="menuLink"><a href="http://retail01.safeway.com/" class="sprite_10 TopTab1"></a></li> 
							   <li class="menuLink"><a href="#" class="sprite_10 TopTab2" id="pullerr"></a></li> 
							   <li class="menuLink"><a href="#" class="sprite_10 TopTab3" id="puller"></a></li> 
							   <li class="menuLink"><a href="#" class="sprite_10 TopTab4" id="pullerh"></a></li>
							   <li class="menuLink"><a id="link-directory" href="/assets/directorylookup/ldaplookup.php" target="_blank" class="sprite_10 TopTab5" id="pullerh"></a></li>
							   <li class="menuLink"><a href="https://mail.safeway.com/" target="_blank" class="sprite_10 TopTab6"></a></li> 
