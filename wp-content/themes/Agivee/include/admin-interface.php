...
<ul class="tabs"> 
    ...
    <li><a href="#slideshow"><?php echo 'Slideshow'; ?></a></li>
...
<form method="post" id="podiumsettings">
<!-- tab "panes" --> 
<div class="panes">
<?php 
$num = 0;
foreach ($options as $value) {
	...
	switch ( $value['type'] ) {
      ...
      foreach ($value['options'] as $key => $option) { 
          $checked = ""; 
              //if ($show_hide_pg[0]) { if ( in_array($key, $show_hide_pg[0])) $checked = "checked=\"checked\""; 
    ...
    <thead>
    <tr valign="top">
      <th style="text-align:left;font-style:italic;font-family:Georgia, 'Times New Roman', Times, serif;font-size:1.3em;" colspan="3">
          <?php echo $value['name']; ?>
      </th>
    </tr>
    </thead>
